...
import 'results_page_ratings_saved_model.dart';
export 'results_page_ratings_saved_model.dart';

class ResultsPageRatingsSavedWidget extends StatefulWidget {
  const ResultsPageRatingsSavedWidget({
    super.key,
    required this.date,
  ...
  @override
  State<ResultsPageRatingsSavedWidget> createState() =>
      _ResultsPageRatingsSavedWidgetState();
}

class _ResultsPageRatingsSavedWidgetState
    extends State<ResultsPageRatingsSavedWidget> {
  late ResultsPageRatingsSavedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResultsPageRatingsSavedModel());
  }
